...
public class FragmentStats extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        TextView totalEntriesV1 = view.findViewById(R.id.total_entries_v1);
        ...
        TextView totalEntriesV2 = view.findViewById(R.id.total_entries_v2);
        ...
        totalEntriesV1.setText(getString(R.string.total_entries, db.getTotalEntries(SYNC_MESSAGE_V1)));
        ...
        totalEntriesV2.setText(getString(R.string.total_entries, db.getTotalEntries(SYNC_MESSAGE_V2)));
